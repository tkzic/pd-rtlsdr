...
//
// but I have not yet dismantled all the structs for demodulation and scanning
//
...
// tz - what exactly is this doing? It only gets called if radio is not in 'offset' mode
//
...
// tz this can get cleaned up too...
        ...
        usleep(100000);
//        errx = pthread_create(&output.thread, NULL, output_thread_fn, (void *)(&output));
//        errx = pthread_create(&demod.thread, NULL, demod_thread_fn, (void *)(&demod));
